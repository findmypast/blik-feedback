...
urlpatterns = [
    ...
    path('dashboard/organisation-cycles/<uuid:cycle_uuid>/reports/', admin_views.organisation_cycle_reports, name='organisation_cycle_reports'),
    path('dashboard/organisation-cycles/<uuid:cycle_uuid>/reports/<int:reviewee_id>/', admin_views.organisation_person_combined_reports, name='organisation_person_combined_reports'),
